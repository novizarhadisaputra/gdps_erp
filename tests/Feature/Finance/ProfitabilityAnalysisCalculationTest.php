...
class ProfitabilityAnalysisCalculationTest extends TestCase
{
    ...
    {
        $manpowerCat = DirectCostCategory::firstOrCreate(['code' => 'manpower'], ['name' => 'Man Power']);
        $toolsCat = DirectCostCategory::firstOrCreate(['code' => 'tools_equipment'], ['name' => 'Tools & Equipment']);
    ...
    {
        // Mock Notification
        $notificationMock = Mockery::mock('overload:Filament\Notifications\Notification');
        $notificationMock->shouldReceive('make')->andReturnSelf();
        $notificationMock->shouldReceive('title')->andReturnSelf();
        $notificationMock->shouldReceive('body')->andReturnSelf();
        $notificationMock->shouldReceive('danger')->andReturnSelf();
        $notificationMock->shouldReceive('send')->andReturn();
