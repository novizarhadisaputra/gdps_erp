...
return new class extends Migration
{
    ...
    {
        Schema::create(config('database.default') === 'sqlite' ? 'bpjs_health_configs' : 'master_data.bpjs_health_configs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('database.default') === 'sqlite' ? 'bpjs_health_configs' : 'master_data.bpjs_health_configs');
    }
};
