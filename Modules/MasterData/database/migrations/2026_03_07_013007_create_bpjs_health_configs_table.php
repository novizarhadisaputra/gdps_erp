...
return new class extends Migration
{
    ...
    {
        Schema::create(config('database.default') === 'sqlite' ? 'master_data_bpjs_health_configs' : 'master_data.bpjs_health_configs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('database.default') === 'sqlite' ? 'master_data_bpjs_health_configs' : 'master_data.bpjs_health_configs');
    }
};
