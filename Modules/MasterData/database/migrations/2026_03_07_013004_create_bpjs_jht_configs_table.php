...
return new class extends Migration
{
    ...
    {
        Schema::create(config('database.default') === 'sqlite' ? 'bpjs_jht_configs' : 'master_data.bpjs_jht_configs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('database.default') === 'sqlite' ? 'bpjs_jht_configs' : 'master_data.bpjs_jht_configs');
    }
};
