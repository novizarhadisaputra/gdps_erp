...
return new class extends Migration
{
    ...
    {
        Schema::create(config('database.default') === 'sqlite' ? 'jkk_configs' : 'master_data.jkk_configs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('database.default') === 'sqlite' ? 'jkk_configs' : 'master_data.jkk_configs');
    }
};
