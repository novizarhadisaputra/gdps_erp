...
class TaxTerRateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $categoryB = [
            ...
            ['min' => 100750001, 'max' => null, 'rate' => 34],
        ];
        ...
        $categoryC = [
            ...
            ['min' => 20400001, 'max' => null, 'rate' => 34],
        ];

        foreach ($categoryA as $row) {
            TaxTerRate::create(['type' => 'monthly', 'category' => 'A', 'min_gross' => $row['min'], 'max_gross' => $row['max'], 'rate' => $row['rate']]);
        }
        foreach ($categoryB as $row) {
            TaxTerRate::create(['type' => 'monthly', 'category' => 'B', 'min_gross' => $row['min'], 'max_gross' => $row['max'], 'rate' => $row['rate']]);
        }
        foreach ($categoryC as $row) {
            TaxTerRate::create(['type' => 'monthly', 'category' => 'C', 'min_gross' => $row['min'], 'max_gross' => $row['max'], 'rate' => $row['rate']]);
        }
    }
}
