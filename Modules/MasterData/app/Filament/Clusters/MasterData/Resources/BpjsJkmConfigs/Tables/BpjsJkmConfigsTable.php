...
namespace Modules\MasterData\Filament\Clusters\MasterData\Resources\BpjsJkmConfigs\Tables;
...
class BpjsJkmConfigsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ->description(__('Life Insurance (JKM) configurations for participants. Manages contribution percentages and limits.'))
            ->columns([
