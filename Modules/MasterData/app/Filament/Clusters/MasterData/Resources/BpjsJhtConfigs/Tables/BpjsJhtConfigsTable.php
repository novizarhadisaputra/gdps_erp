...
namespace Modules\MasterData\Filament\Clusters\MasterData\Resources\BpjsJhtConfigs\Tables;
...
class BpjsJhtConfigsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ->description(__('Old Age Security (JHT) configurations for participants. Manages contribution percentages and basis.'))
            ->columns([
