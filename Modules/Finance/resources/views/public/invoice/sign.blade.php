<x-layouts.guest>
    <div class="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
            ...
            <div class="flex items-center justify-between border-b border-gray-100 pb-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-extrabold text-gray-800">Invoice Signature Portal</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-xs text-gray-400">Invoice Number</p>
                    <p class="text-sm font-bold text-blue-600">{{ $invoice->invoice_number }}</p>
            ...
            <div class="border-t border-b border-gray-100 py-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-blue-600">IDR {{ number_format($invoice->amount, 2) }}</p>
                    </div>
                    <div>
            ...
            <form action="{{ URL::temporarySignedRoute('invoices.public.submit', now()->addMinutes(60), ['invoice' => $invoice]) }}" method="POST" id="signature-form" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" name="sender_email" id="sender_email" required
                               class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                               placeholder="e.g. youremail@company.com" value="{{ old('sender_email', $invoice->customer?->email) }}">
                    </div>
                    <div class="md:col-span-2">
                        <label for="signed_document" class="block text-sm font-medium text-gray-700">Signed Invoice File <span class="text-red-500">*</span></label>
    ...
    <div id="confirm-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 p-8">
            ...
            <p class="text-sm text-gray-600 mb-6">
                By clicking <strong>Confirm & Submit</strong>, you confirm that you have reviewed this Invoice and agree to its terms. This action cannot be undone.
            </p>
