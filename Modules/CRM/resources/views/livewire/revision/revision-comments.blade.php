    ...
    <div class="p-6 transition-all duration-300 border border-gray-100 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-md">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
                <textarea 
                    wire:model="body" 
                    placeholder="Add an internal audit note or feedback..."
                ...
                <div class="flex justify-end pt-4 mt-2 border-t border-gray-100 dark:border-gray-800">
                    ...
                    >
                        <span wire:loading.remove wire:target="postComment">Post Audit Note</span>
    ...
    <div class="relative space-y-6">
        ...
        @if($comments->isEmpty())
            <div class="relative flex flex-col items-center justify-center py-12 text-center group">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Be the first to leave an audit note for this revision.</p>
            </div>
        @endif
    </div>
</div>
