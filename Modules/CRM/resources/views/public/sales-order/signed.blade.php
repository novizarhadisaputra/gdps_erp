    ...
    <div class="min-h-screen bg-gray-50 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Thank you for your response. The Sales Order <span class="font-bold text-gray-900">#{{ $salesOrder->so_number }}</span> has been successfully approved and signed.
            </p>
            <p class="text-xs text-gray-400 mt-4">
                A confirmation has been sent to our team. You can now close this window.
            </p>
