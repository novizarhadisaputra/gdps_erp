...
return new class extends Migration
{
    ...
    {
        Schema::create(config('database.default') === 'sqlite' ? 'work_orders' : 'crm.work_orders', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('database.default') === 'sqlite' ? 'work_orders' : 'crm.work_orders');
    }
};
