...
namespace Modules\Project\Filament\Clusters\Project\Resources\WorkHandovers\Schemas;
            ...
            ->components([
                Section::make('General Information')
                    ->schema([
                        Grid::make(2)
                            ->schema([
                                TextInput::make('handover_number')
                                ...
                                Select::make('status')
                                    ...
                                    ->required()
                                    ->default(WorkHandoverStatus::Draft),
                            ]),
                    ]),
